...
import 'package:shiksha_hub/department_head/d_time_table/semester.dart';
...
// ─────────────────────────────────────────────────────────────────────────────
//  ICON + DESCRIPTION HELPERS  (same keyword table as SelectBranchAdmin)
// ─────────────────────────────────────────────────────────────────────────────
...
class _BranchAdminState extends State<BranchAdmin>
  ...
  void _go(String id, String name) => Navigator.of(context).push(
    PageRouteBuilder(
      pageBuilder: (_, __, ___) => SemesterPage(
...
// ─────────────────────────────────────────────────────────────────────────────
//  BRANCH CARD  (identical look to SelectBranchAdmin's _BranchCard)
// ─────────────────────────────────────────────────────────────────────────────
