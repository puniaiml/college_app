import 'package:shiksha_hub/department_head/department_analysis.dart';
import 'package:shiksha_hub/department_head/faculty_management.dart';
import 'package:shiksha_hub/department_head/scheme_hod.dart';
import 'package:shiksha_hub/department_head/semester_management.dart';
import 'package:shiksha_hub/department_head/student_management_page.dart';
import 'package:shiksha_hub/hod&faculty/mentor.dart';
import 'package:shiksha_hub/widgets/profile_page_hod.dart';
...
class HodDrawer extends StatefulWidget {
  const HodDrawer({super.key});

  @override
  State<HodDrawer> createState() => _HodDrawerState();
}

class _HodDrawerState extends State<HodDrawer>
  ...
  // Colors - HOD specific purple theme
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (user != null) {
        // Get from department_head collection (FIXED - was using faculty)
        ...
        if (doc.exists) {
          ...
          setState(() {
            userData = {
              'name': user.displayName ?? 'HOD',
              'email': user.email ?? 'No email',
              'collegeName': 'Department Head',
              'role': 'HOD',
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            // Branch/Department Name (specific for HOD)
            if (userData?['branchName'] != null) ...[
              const SizedBox(height: 6),
              Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: 12,
                      ...
                      children: [
                        _buildDrawerItem(
                          ...
                          onTap: () {
                            ...
                            Get.to(() => const HodBranchDashboard());
                          },
                        ...
                        _buildDrawerItem(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            Get.to(() => const HODSemesterManagementPage());
                          },
                          iconColor: const Color.fromARGB(255, 243, 35, 216),
                          index: 1,
                        ),
                        _buildDrawerItem(
                          icon: Icons.article_rounded,
                          title: "Scheme & Subject Management",
                          onTap: () {
                            Navigator.pop(context);
                            Get.to(() => const HODSchemeManagementPage());
                          },
                        ...
                        _buildDrawerItem(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            Get.to(() => const HODStudentManagementPage());
                          },
                        ...
                        _buildDrawerItem(
                          ...
                          onTap: () {
                            Navigator.pop(context);
                            // Add assignments page navigation
                          },
