import 'package:shiksha_hub/user/u_time_table/timetable_page.dart';
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class StudentSelectSectionPage extends StatefulWidget {
  ...
  const StudentSelectSectionPage({
    super.key,
  ...
  @override
  State<StudentSelectSectionPage> createState() =>
      _StudentSelectSectionPageState();
}

class _StudentSelectSectionPageState extends State<StudentSelectSectionPage>
  ...
  void _goToTimetable(String sectionId, String sectionName) {
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => StudentTimetableViewPage(
