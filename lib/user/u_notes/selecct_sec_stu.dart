...
import 'package:shiksha_hub/user/u_notes/usersubject_selection.dart';
import 'package:shiksha_hub/user/user_home.dart';

// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (mirrors SectionSelectionPage / select_semester.dart)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class StudentSectionSelectionPage extends StatefulWidget {
  ...
  const StudentSectionSelectionPage({
    super.key,
  ...
  @override
  State<StudentSectionSelectionPage> createState() =>
      _StudentSectionSelectionPageState();
}

class _StudentSectionSelectionPageState
    extends State<StudentSectionSelectionPage>
  ...
  void _go(String sectionName, String sectionId) => Navigator.push(
    context,
    PageRouteBuilder(
      pageBuilder: (_, __, ___) => StudentSelectSubjectPage(
