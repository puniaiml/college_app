...
import 'package:shiksha_hub/user/u_notes/view_pdf_user.dart';
import 'package:shiksha_hub/user/user_home.dart';

// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (mirrors ChapterModulePage)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class StudentChapterModulePage extends StatefulWidget {
  ...
  const StudentChapterModulePage({
    super.key,
  ...
  @override
  State<StudentChapterModulePage> createState() =>
      _StudentChapterModulePageState();
}

class _StudentChapterModulePageState extends State<StudentChapterModulePage>
  ...
  void _go(String module) => Navigator.push(
        context,
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => StudentViewPdfPage(
