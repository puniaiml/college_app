...
import 'package:shiksha_hub/faculty/f_time_table/branch.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void navigateToPage(String textSpeech) {
    ...
    if (textSpeech.contains('notes')) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const BranchFaculty(selectedCollege: '',)),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const FacultyBranchAdmin(selectedCollege: '',)),
      );
