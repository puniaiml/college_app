...
import 'package:shiksha_hub/faculty/f_notes/subject.dart';

// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (identical to SectionSelectionPage)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class FacultySectionSelectionPage extends StatefulWidget {
  ...
  const FacultySectionSelectionPage({
    super.key,
  ...
  @override
  State<FacultySectionSelectionPage> createState() =>
      _FacultySectionSelectionPageState();
}

class _FacultySectionSelectionPageState
    extends State<FacultySectionSelectionPage>
  ...
  void _go(String sectionName, String sectionId) => Navigator.push(
    context,
    PageRouteBuilder(
      pageBuilder: (_, __, ___) => FacultySelectSubjectPage(
...
// ─────────────────────────────────────────────────────────────────────────────
//  SECTION CARD  (identical to SectionSelectionPage's _SectionCard)
// ─────────────────────────────────────────────────────────────────────────────
