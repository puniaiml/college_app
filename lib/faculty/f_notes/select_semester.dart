import 'package:shiksha_hub/faculty/f_notes/select_section_fac.dart';
...
// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (identical to SelectSemesterPage)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class FacultySelectSemesterPage extends StatefulWidget {
  ...
  const FacultySelectSemesterPage({
    super.key,
  ...
  @override
  State<FacultySelectSemesterPage> createState() =>
      _FacultySelectSemesterPageState();
}

class _FacultySelectSemesterPageState extends State<FacultySelectSemesterPage>
  ...
  Future<void> _loadSemesters() async {
    try {
      ...
      list.sort((a, b) =>
          (a['semNum'] as int).compareTo(b['semNum'] as int));
  ...
  // ── Navigation ──────────────────────────────────────────────────────────────
  void _go(String semesterName) => Navigator.push(
    context,
    PageRouteBuilder(
      pageBuilder: (_, __, ___) => FacultySectionSelectionPage(
          ...
          return RepaintBoundary(
            child: AnimatedBuilder(
              ...
              child: _SemesterCard(
                ...
                semNum: s['semNum'] as int,
                accent: s['accent'] as Color,
                onTap:  () => _go(s['name'] as String),
              ),
            ),
          );
        },
...
// ─────────────────────────────────────────────────────────────────────────────
//  SEMESTER CARD  (identical to SelectSemesterPage's _SemesterCard)
// ─────────────────────────────────────────────────────────────────────────────
