...
import 'package:shiksha_hub/faculty/f_notes/select_semester.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (identical to SelectSchemePage)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class FacultySelectSchemePage extends StatefulWidget {
  final String selectedCollege;
  final String branch;
  final String branchId;

  const FacultySelectSchemePage({
    super.key,
  ...
  @override
  State<FacultySelectSchemePage> createState() => _FacultySelectSchemePageState();
}

class _FacultySelectSchemePageState extends State<FacultySelectSchemePage>
  ...
  Future<void> _loadSchemes() async {
    try {
      ...
      final courseId = facultySnap.data()!['courseId'] as String?;
      ...
      for (final doc in snap.docs) {
        ...
        list.add({
          'id':           doc.id,
          'title':        name,
          'subtitle':     _buildSubtitle(academicYear, description),
  ...
  void _go(Map<String, dynamic> scheme) => Navigator.of(context).push(
    PageRouteBuilder(
      pageBuilder: (_, __, ___) => FacultySelectSemesterPage(
...
// ─────────────────────────────────────────────────────────────────────────────
//  SCHEME CARD  (identical to SelectSchemePage's _SchemeCard)
// ─────────────────────────────────────────────────────────────────────────────
