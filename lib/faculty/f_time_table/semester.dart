...
import 'package:shiksha_hub/faculty/f_time_table/select_section.dart';
...
// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (identical to SemesterPage)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class FacultySemesterPage extends StatefulWidget {
  final String selectedCollege;
  final String branchId;
  final String branchName;

  const FacultySemesterPage({
    super.key,
  ...
  @override
  State<FacultySemesterPage> createState() => _FacultySemesterPageState();
}

class _FacultySemesterPageState extends State<FacultySemesterPage>
    ...
    try {
      ...
      final list = snap.docs.map((doc) {
        ...
        return {
          ...
          'createdByType': d['createdByType']?.toString(),
          'data':          d,
        };
      }).toList();
  ...
  void _goToSection(String semesterId, String semesterName) {
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => FacultySelectSectionPage(
      ...
      child: Column(
        ...
        children: [
          ...
          if (createdByType != null) ...[
            const SizedBox(height: 4),
            Text(
              'Created by ${createdByType == 'admin' ? 'Admin' : 'HOD'}',
              style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 12,
