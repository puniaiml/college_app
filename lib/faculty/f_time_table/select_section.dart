import 'package:shiksha_hub/faculty/f_time_table/timetable_page.dart';
...
// ─────────────────────────────────────────────────────────────────────────────
//  DESIGN TOKENS  (mirrors SelectSectionPage exactly)
// ─────────────────────────────────────────────────────────────────────────────
class _C {
...
//  MAIN WIDGET
// ─────────────────────────────────────────────────────────────────────────────
class FacultySelectSectionPage extends StatefulWidget {
  ...
  const FacultySelectSectionPage({
    super.key,
  ...
  @override
  State<FacultySelectSectionPage> createState() =>
      _FacultySelectSectionPageState();
}

class _FacultySelectSectionPageState extends State<FacultySelectSectionPage>
  ...
  // ── Navigation ────────────────────────────────────────────────────────────────
  void _goToTimetable(String sectionId, String sectionName) {
    Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (_, __, ___) => FacultyTimetableViewPage(
  ...
  Widget _body() {
    ...
    if (_error != null && _sections.isEmpty) {
      return _ErrorView(error: _error!, onRetry: _loadSections);
    }
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Breadcrumb chip  →  branch › semester
                Container(
                  padding: const EdgeInsets.symmetric(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'No sections found for $semesterName in $branchName.\nContact your department head.',
            textAlign: TextAlign.center,
            style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 13,
