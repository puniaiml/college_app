...
class FacultyBranchAdmin extends StatefulWidget {
  final String selectedCollege;

  const FacultyBranchAdmin({super.key, required this.selectedCollege});

  @override
  State<FacultyBranchAdmin> createState() => _FacultyBranchAdminState();
}

class _FacultyBranchAdminState extends State<FacultyBranchAdmin> with TickerProviderStateMixin {
  ...
  Future<void> _loadAvailableBranches() async {
    try {
      ...
      String? collegeId = facultyData['collegeId'] as String?;
      String? collegeName = facultyData['collegeName'] as String?;
      String? universityId = facultyData['universityId'] as String?;
      String? universityName = facultyData['universityName'] as String?;
  ...
  IconData _getBranchIcon(String branchName) {
    ...
    } else if (name.contains('artificial') || name.contains('ai') || name.contains('ml')) {
...
Widget build(BuildContext context) {
  ...
  return AnnotatedRegion<SystemUiOverlayStyle>(
    ...
    child: Scaffold(
      ...
      body: SafeArea(
        top: false, // This is the key change - don't apply SafeArea to the top
        child: Stack(
          children: [
            AnimatedBackground(
              ...
              children: [
                Container(
                  padding: EdgeInsets.only(
                    top: MediaQuery.of(context).padding.top, // Add status bar height as padding
                  ),
                  height: kToolbarHeight + 60 + MediaQuery.of(context).padding.top, // Include status bar height
  ...
  void _navigateToSemesterPage(BuildContext context, String branchId, String branchName) {
    Navigator.of(context).push(
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) => FacultySemesterPage(
